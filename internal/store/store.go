...
// InsertEventAndProcess stores one delivery and applies its durable side
// effects atomically. It returns false when another delivery has already
// claimed the event ID.
func (s *Store) InsertEventAndProcess(ctx context.Context, e Event) (bool, error) {
